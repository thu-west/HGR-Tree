...
/// sizeof<void*> and simple type ELEMTYPE Type of element such as int or double
/// NUMDIMS Number of dimensions such as 2 or 3
/// ELEMTYPEREAL Type of element that allows fractional and large values such as
/// double or double, for use in volume calcs
///
...
class RTree {
 ...
 public:
  ...
  struct Node {
    ...
    Node* parent;
    Rectangle rect;
    std::vector<int> ids;  // <strlen, obj_ids>
    HashMap<int, InvertedList> inverted_lists;
    Node() { parent = nullptr; l_min = 10000; l_max = -10000; id = -1; }
  };
